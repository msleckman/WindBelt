...
sd(ventyx_df_google_Sen$Capacity)
mean(ventyx_df_google_Sen$Capacity, na.rm = T)
?mean()

class(ventyx_df_google_Sen$Capacity)

View(ventyx_df_google_Sen)

ventyx_df_google_Sen <- ventyx_df_google_Sen %>% 
  mutate(Capacity_norm_2 = (Capacity - mean(Capacity, na.rm = T))/sd(Capacity, na.rm = T))
