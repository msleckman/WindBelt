...
#Merge with original data that already has NU scores
...
####Convert sentiment scores to positive or negative (optional)
```{r pos_or_neg_sen}
...
#Results: significance found in household median income (0.00318) and capacity (0.00613). 
#NU sentiment p-value: 0.29392
#H_L_W p-value: 0.659
####
...
#Results: significance found in household median income (0.002891) and capacity (0.004197)
#NU sentiment p-value: 0.7977
#H_L_W p-value: 0.071168
#Interaction: 0.067685
####
...
#Results: significance found in Google sentiment (0.02481) and capacity (0.09117)
