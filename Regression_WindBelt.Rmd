...
dwplot(reg_TLD_VS_GSen_PopDen_MedianIncome_Cap_HL_State_Inter, order_vars = c("View_score, Google_Sentiment"))+
    theme_bw()+
  labs(x = "timeline")
...
filtered_r5 <- tidy(reg_TLD_ZEROES_VS_GNSen_PopDen_MedianIncome_Cap_HL_State) %>% 
  filter(term != "View_Score")
...
+ # plot line at zero _behind_ coefs
  relabel_predictors(c(View_Score = "view Score",
