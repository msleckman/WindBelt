...
logistic_reg_bivariate <- glm(Canceled ~  H_L_W, family = binomial, data = train)
...
mean(pred_probs_trunc_df_Above50_High$Probability)
mean(pred_probs_trunc_df_Above50_Low$Probability)

ggplot(pred_probs_trunc_df_Above50, aes(x = H_L_W, fill = H_L_W)) +
  ...
  ggtitle("Unfinished Projects with a Probability of Cancelation Greater than 50%\n")
```
